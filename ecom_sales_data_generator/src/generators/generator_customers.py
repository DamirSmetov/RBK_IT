...
def generate_customers(num_customers=1000, faker=None, config=None, guest_shopper_pct=0.4, global_start_date: datetime.date = None, global_end_date: datetime.date = None):
    ...
    # If global_start_date is provided, use it directly instead of calculating from signup_years
    if global_start_date is not None:
        signup_start_date = global_start_date
    else:
        # Fallback to using signup_years parameter if global_start_date not provided
